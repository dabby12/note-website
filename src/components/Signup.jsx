  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gradient-to-br from-light-blue-200 to-light-purple-100">
      <form
        ...
        className="bg-white dark:bg-dark-700 p-8 rounded-lg shadow-lg max-w-md w-full animate-fade-in opacity-100"
      >
        <h2 className="text-3xl font-bold mb-6 text-center text-dark-800 dark:text-light-blue-100">
          Sign Up
        </h2>
        ...
        <button
          type="submit"
          className="bg-light-purple-500 text-white p-3 rounded w-full hover:bg-light-purple-600 transition duration-300 hover:animate-pulse-fast"
        >
          Sign Up
        </button>
        ...
        <h1 className="text-center mt-4 text-dark-700 dark:text-neutral-300">
          ...
          <a
            href="/login"
            className="text-light-blue-700 hover:text-light-blue-500 dark:text-light-blue-300"
          >
            Login
          </a>
        </h1>
