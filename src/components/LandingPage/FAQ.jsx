  ...
  const faqItems = [
    {
      ...
      answer:
        "Click on the '+' button in the navigation bar and select 'New Note'. You can then add a title and content to your note.",
    },
    {
      question: "Can I organize my notes into folders?",
      answer:
        "Yes, you can create folders by clicking on 'Folders' in the sidebar and selecting 'New Folder'. You can then drag and drop notes into your folders.",
    },
    {
      question: "How do I search for notes?",
      answer:
        "Use the search bar at the top of the app. You can search by title, content, or tags.",
    },
    {
      question: "Can I format text in my notes?",
      answer:
        "Yes, you can use markdown or the formatting toolbar to bold, italicize, create lists, and more in your notes.",
    },
    {
      question: "Is my data synced across devices?",
      answer:
        "Yes, all your notes are automatically synced across all your devices when you're connected to the internet.",
    },
  ];
