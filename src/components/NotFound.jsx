  ...
  return (
    <section class="bg-white dark:bg-gray-900 ">
      <div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        ...
        <div class="relative w-full mt-8 lg:w-1/2 lg:mt-0 rounded-lg">
          <img class="w-full lg:h-[32rem] h-80 md:h-96 rounded-lg object-cover" src="https://picsum.photos/2070/1600" alt="Random image from Picsum" />
          <p class="mt-4 text-center text-gray-500 dark:text-gray-400">Enjoy this random image while you find your way back!</p>
        </div>
      </div>
    </section>
  )
