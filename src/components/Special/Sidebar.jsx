...
const Sidebar = () => {
    ...
    const items = [
        { icon: MdAccountCircle, label: "User Account", onClick: handleSidebarClickOnUserAccount },
        { icon: RiListSettingsFill, label: "App Preferences", onClick: handleSidebarClickOnAppPreferences },
        { icon: FaShieldAlt, label: "Privacy & Security", onClick: handleSidebarClickOnPrivacySecurity },
    ];
